...
Last Update: $Date: 2012-10-09 02:54:55 +0000 (Tue, 09 Oct 2012) $
Website:
Documentation:
SVN: $URL $
Dependencies: UTF8
...
local combatRatingBonus = {
	...
	[90] = {
		--comes from linear regressions of Rating -> Bonus
		[CR_PARRY] =       null, --Parry Rating / Parry Chance %
		[CR_DODGE] =       null, --Dodge Rating / Dodge Chance %
...
--]]	
	...
	local p = 5; --Base Dodge (e.g. 3%)
	local R = GetCombatRatingBonus(CR_DODGE); --Dodge Rating Bonus (e.g. 13.73% Dodge from Dodge Rating)
	local P = GetDodgeChance(); --Dodge Chance, after diminishing returns (e.g. 27.18% Dodge Chance)
	local s = agi-posBuff; --Base Agility
	local S = posBuff; --Bonus Agility
	...
	--print(string.format("GetDodgePerStr: Qs = %s", Qs));
	return Qa, "DODGE";
end;
