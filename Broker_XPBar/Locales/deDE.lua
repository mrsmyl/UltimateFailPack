...
L["Display settings for bar text."] = "Zeige Einstellungen für Leistenbeschriftung"

L["Show Bar Text"] = "Zeige Beschriftung"
L["Show current progress values on bar."] = "Zeige aktuelle Fortschrittswerte als Beschriftung auf Balken"
L["Mouse-Over"] = "Mouse-Over"
L["Show text only on mouse over bar."] = "Zeige Text nur, wenn maus über Leiste"
L["Font"] = "Schriftart"
L["Font of the bar text."] = "Schriftart der Beschriftung"
...
L["The font size of the text."] = "Schriftgröße der Beschriftung"
L["Show XP/Rep to go in bar text"] = "Zeige verbleibende Erfahrung/Ruf in Beschriftung"
L["Show faction name in bar text."] = "Zeige Fraktion in Beschriftung"
L["Show values in bar text"] = "Zeige absolute Fortschrittswerte in Beschriftung"
L["Show percentage in bar text"] = "Zeige prozentualen Fortschritt in Beschriftung"
L["Show rested value in bar text"] = "Zeige Ruhebonus in Beschriftung"
L["Show rested percentage in bar text"] = "Zeige prozentualen Ruhebonus in Beschriftung"
...
L["Show Values"] = "Zeige Werte"
L["Show values in label text"] = "Zeige absolute Fortschrittswerte in Beschriftung"
L["Show Percentage"] = "Zeige Prozent"
L["Show percentage in label text"] = "Zeige prozentualen Fortschritt in Beschriftung"
L["Show Rested"] = "Zeige Ruhebonus"
L["Show rested value in label text"] = "Zeige Ruhebonus in Beschriftung"
L["Show Rested %"] = "Zeige ruhebonus %"
L["Show rested percentage in label text"] = "Beschriftung basierend auf Prozentwerten färben"
L["Colored Label"] = "Beschriftung färben"
L["Color label text based on percentages"] = "Beschriftung basierend auf Fortschritt einfärben"

L["Tooltip"] = "Tooltip"
L["Tooltip Properties"] = "Tooltip-Eigenschaften"
