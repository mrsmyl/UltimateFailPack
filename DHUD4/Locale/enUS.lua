...
L["Breath you"] = true
L["Buffs"] = true
L["By default the buff border starts changing toward <Expiration> when there are 20 seconds remaining."] = true
L["Cast"] = true
L["Cast Bar"] = true
...
L["Colors"] = true
L["Color the bar border according to the class"] = true
L["Columns"] = true
L["Combat"] = true
L["Combos"] = true
L["Complete"] = true
...
L["Druid Eclipse"] = true
L["Druid Mana"] = true
L["Druid Mana Tracking"] = true
L["Eclipse Bar Font size"] = true
L["Eclipse Bar Values"] = true
L["Eclipse Lunar Phase"] = true
L["Eclipse percent"] = true
...
L["Position"] = true
L["Position of the cast bar, Player bar has precedence"] = true
L["Power"] = true
L["Power Style"] = true
...
L["Range"] = true
L["Range Colors"] = true
L["Ranges are approximate and can vary according to class, race, spec, etc."] = true
...
L["Roughly 0 ~ 8 yards"] = true
L["Roughly 25 ~ 45 yards"] = true
L["Roughly 45 ~ 60 yards"] = true
L["Roughly 60 ~ 80 yards"] = true
L["Roughly 8 ~ 25 yards"] = true
L["Round Robin"] = true
L["Rune Layout"] = true
L["Runic Power"] = true
L["See you"] = true
...
L["Show Eclipse as percent"] = true
L["Show/Hide"] = true
...
L["Side"] = true
L["Side to show the cast bar, Player bar has precedence"] = true
L["Size"] = true
L["Spell Name"] = true
L["Status Icons"] = true
...
L["The pet module manages pet bars and text and happiness icon. The pet bars can track druid mana and vehicle status"] = true
...
L["Unavailable"] = true
L["Use bar border to display class color"] = true
L["Use bar border to display range information"] = true
...
L["Set how to display the runes. Round Robin places them in a single vertical row, runes rotate moving used ones to the top of the line. Bottom up places them at the lower side of the bars, grouped in pairs. Half'n'Away places them at the center of the bar, in vertical pairs positioned away from the bar. Centered places the runes in the center of the HUD, above the target's name plate (in this mode side setting for abilities won't have any difference)."] = true
L["Track Death Knight Runes"] = true
-- Locales from Copy of DHUD4_Druid.lua
L["Bar to track eclipse"] = true
L["Bar"] = true
L["Druid Eclipse"] = true
L["Eclipse Bar Font size"] = true
