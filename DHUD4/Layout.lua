--[[
Layout.lua
Copyright (c) 2006 by Markus Inger, 2006 by Caeryn Dryad, 2007-20010 by Horacio Hoyos
...
-- Layout Settings
local VERSION = tonumber(("$Rev: 3 $"):match("%d+"));
DHUD4.layout = {
	...
	playerBars = {
        li = {
            ...
            "BOTTOM",
            "leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\1",
            "Interface\\AddOns\\DHUD4\\textures\\1b",
            "iGap",
        },
        lm = {
            "BOTTOM",
            ...
            "BOTTOM",
            "leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\2",
            "Interface\\AddOns\\DHUD4\\textures\\2b",
            "mGap",
        },
        ri = {
            "BOTTOM",
    ...
    outerBars = {        
        lo = {
            ...
            "BOTTOM",
            "leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\3",
            "Interface\\AddOns\\DHUD4\\textures\\3b",
            "mGap",
        },
        ro = {
            "BOTTOM",
    ...
    petBars = {    
        lpo = {
            ...
            "BOTTOM",
			"leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\p1",
            "Interface\\AddOns\\DHUD4\\textures\\p1b",
			"eGap",
        },
        lpi = {
            "BOTTOM",
            ...
            "BOTTOM",
            "leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\p2",
            "Interface\\AddOns\\DHUD4\\textures\\p2b",
			"eGap",
        },
        rpo = {
            "BOTTOM",
    ...
    castBars = {
        lc = {
            ...
            "BOTTOM",
            "leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\cb",
            "Interface\\AddOns\\DHUD4\\textures\\cb",
            "iGap",
        },
        lcf = {
            ...
            "BOTTOM",
            "leftPosition",
            "Interface\\AddOns\\DHUD4\\textures\\cbh",
            "Interface\\AddOns\\DHUD4\\textures\\cb",
            "iGap",
        },
    ...
    icons = {
        ...
        ltelite = {
            ...
            0,
            1,
            "Interface\\AddOns\\DHUD4\\textures\\elite"
        },
