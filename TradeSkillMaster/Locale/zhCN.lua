...
L["No modules are currently loaded.  Enable or download some for full functionality!"] = "当前未加载任何模块。启用或下载一些模块以完善插件功能！" -- Needs review
...
L["%sDrag%s to move this button"] = "%s点住%s拖动此按钮位置" -- Needs review
...
L["%sLeft-Click%s to open the main window"] = "%s左键点击%s打开主窗口" -- Needs review
...
L["Translators:"] = "翻译者："
L["\"/tsm adbreset\" will reset AuctionDB's scan data. There is a confirmation prompt."] = "\"/tsm adbreset\" 将重置 AuctionDB 的扫描数据。该操作会弹出确认提示。" -- Needs review
