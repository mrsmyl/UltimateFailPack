...
L["Copy the settings from one existing profile into the currently active profile."] = "Скопировать настройки существующего профиля в текущий." -- Needs review
-- L["Crafting Cost:"] = ""
-- L["Crafting Mats"] = ""
L["Create a new empty profile."] = "Создать новый пустой профиль." -- Needs review
L["Current Profile:"] = "Текущий профиль:" -- Needs review
...
L["Existing Profiles"] = "Существующие профили" -- Needs review
-- L["% Expected Cost"] = ""
-- L["Export List"] = ""
