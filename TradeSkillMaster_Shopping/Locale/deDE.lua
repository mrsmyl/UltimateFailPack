...
L["Add Item to Dealfinding List"] = "Füge Item der Angebotsfinderliste hinzu"
...
L["%s is already in a dealfinding list and has been removed from this list."] = "%s ist bereits in einer Angebotsfinderliste und ist von dieser Liste gelöscht worden."
L["%s item(s) will be removed (already in a dealfinding list)"] = "%s Item(s) werdem gelöscht (bereits in der Angebotsfinderliste)"
...
L["You can either drag an item into this box, paste (shift click) an item link into this box, or enter an itemID."] = "Sie können einen Gegenstand diesem Fenster per Drag&Drop, Shift+Klick oder durch Eingeben der Gegenstands-ID hinzufügen."
