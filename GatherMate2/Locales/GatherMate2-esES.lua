...
L["CLEANUP_RADIUS_DESC"] = "El radio en yardas en el cual se eliminarán los nodos duplicados. Por defectos son |cffffd20050|r yardas para Extraer Gas y |cffffd20015|r yardas para lo demás. Estas opciones también se siguen al añadir nodos."
...
L["Clear zone selections"] = "Borra selección de zonas"
...
L["Database Locking"] = "Bloquear base de datos"
L["DATABASE_LOCKING_DESC"] = "El bloqueo de base de datos permite congelar el estado de una base de datos. Una vez bloqueada no es posible añadir, borrar o modificar la base de datos. Esto incluye la limpieza y la importación."
...
L["DELETE_ENTIRE_DESC"] = "Esto ignorará el bloquear base de datos y borrará todos los nodos de todas las zonas de las bases de datos seleccionadas."
L["Delete selected node from selected zone"] = "Borrar nodos seleccionados de la zona seleccionada"
L["DELETE_SPECIFIC_DESC"] = "Elimina todos los nodos seleccionados de la zona seleccionada. Debes desactivar bloquear base de datos para que esto funcione."
...
2. |cffffff78GatherMate_CartImport|r - Este Addon permite importar tus bases de datos existentes en los módulos de |cffffff78Cartographer_<Profesión>|r en GatherMate. Para que esto funcione, necesitas tener activos a la vez tanto los módulos de |cffffff78Cartographer_<Profesión>|r como GatherMate_CartImport.
...
|cffffd200
¿Quién escribió este Addon tan molón?
|r
...
L["Icon scaling, this lets you enlarge or shrink your icons on the Minimap."] = "Escalar iconos, esto le permite ampliar o reducir sus iconos en el Minimapa."
L["Icon scaling, this lets you enlarge or shrink your icons on the World Map."] = "Escalar iconos, esto le permite ampliar o reducir sus iconos en el Mapa del Mundo."
...
L["Merge will add GatherMateData to your database. Overwrite will replace your database with the data in GatherMateData"] = "Fusionar añadirá los datos de GatherMateData a tu base de datos. Sobrescribir reemplazará tu base de datos con los datos en GatherMateData."
L["Mine filter"] = "Filtrar menas"
L["Mineral Veins"] = "Filones de mineral"
L["Minimap Icons"] = "Iconos del minimapa"
L["Minimap Icon Scale"] = "Escala del icono del Minimapa "
...
L["Only import selected expansion data from WoWhead"] = "Solo importar la expansión seleccionada de Wowhead"
L["Only while tracking"] = "Sólo al rastrear"
L["Only with digsite"] = "Sólo con sitio de excavación"
...
L["Select the archaeology nodes you wish to display."] = "Selecciona los nodos de arqueología que tu deseas visualizar."
...
L["Show Archaeology Nodes"] = "Muestra los nodos de arqueología"
...
L["The distance in yards to a node before it turns into a tracking circle"] = "La distancia en yardas de un nodo antes de que se convierta en un círculo de rastreo."
L["The Frozen Sea"] = "El Mar Gélido"
L["The North Sea"] = "El Mar del Norte"
L["Toggle showing archaeology nodes."] = "Alterna mostrar nodos de arqueología"
...
L["World Map Icon Scale"] = "Escala del icono del Mapa del Mundo"
...
NL["Fool's Cap"] = "Seta del inocente" -- Needs review
...
NL["Giant Mantis Shrimp Swarm"] = "Enjambre de gambas mantis gigantes" -- Needs review
...
NL["Jewel Danio School"] = "Banco de danios enjoyados" -- Needs review
...
NL["Kyparite Deposit"] = "Depósito de kyparita" -- Needs review
...
NL["Maplewood Treasure Chest"] = "Arqueta de madera de arce" -- Needs review
NL["Mithril Deposit"] = "Depósito de mitril"
NL["Mogu Archaeology Find"] = "Hallazgo arqueológico mogu" -- Needs review
...
NL["Rich Kyparite Deposit"] = "Depósito de kyparita rico" -- Needs review
...
NL["Silkweed"] = "Hierbaseda" -- Needs review
...
NL["Sturdy Treasure Chest"] = "Arqueta robusta" -- Needs review
NL["Sungrass"] = "Solea"
...
NL["Trillium Vein"] = "Filón de trillium" -- Needs review
