...
L["Cleanup Failed."] = "정리 실패" -- Needs review
L["Cleanup in progress."] = "정리중" -- Needs review
...
L["Cleanup Started."] = "정리 시작" -- Needs review
...
L["Keybind to toggle Worldmap Icons"] = "세계지도 단축키를 변경합니다." -- Needs review
