...
L["Bartender4 only converts the bindings of Bar1 to be directly usable, all other Bars will have to be re-bound to the Bartender4 keys. A direct indicator if your key-bindings are setup correctly is the hotkey display on the buttons. If the key-bindings shows correctly on your button, everything should work fine as well."] = "Bartender 4 wandelt nur die Tastenbelegungen der Leiste 1 um , alle anderen Leisten müssen als Bartender4-Tasten neu belegt werden (Tastaturbelegung). Um zu sehen, ob die Tastaturbelegung stimmt, überprüfe ob der Hotkey auf dem jeweiligen Knopf zu sehen ist. Wenn die Tastaturbelegung korrekt angezeigt wird, sollte alles funktionieren." -- Needs review
...
L["My BagBar does not have the Keyring on it, how do i get it back?"] = "Meine Taschenleiste hat keinen Schlüsselbund, wie bekomme ich den zurück?" -- Needs review
...
L["Show the keyring button."] = "Zeige den Schlüsselbund-Knopf."
