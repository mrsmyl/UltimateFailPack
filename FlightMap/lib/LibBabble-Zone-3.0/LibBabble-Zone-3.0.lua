...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 292 $"):match("%d+"))
...
elseif GAME_LOCALE == "koKR" then
	...
	["Blackwing Descent"] = "검은날개 강림지", -- Needs review
	...
	["Halls of Origination"] = "시초의 전당", -- Needs review
