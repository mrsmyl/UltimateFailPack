...
FLIGHTMAP_GETHELP       = "help";

FLIGHTMAP_REPAIR = "repair"; -- TODO translate
FLIGHTMAP_HARDRESET = "hardreset"; -- TODO translate

-- Repair and reset confirmation strings
FLIGHTMAP_REPAIR_OK = "Flightmap database repaired"
FLIGHTMAP_HARDRESET_OK = "Flightmap database reset to factory setting"
