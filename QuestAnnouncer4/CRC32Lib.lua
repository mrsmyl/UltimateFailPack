-- Lightweight CRC32 Library for WoW
-- Author: Jason Olivarez

local VERSION = 1.0

local newerVersionLoaded = (
	CRC32Lib and CRC32Lib.version >= VERSION
)

if not isBetterInstanceLoaded then
	CRC32Lib = {};
	CRC32Lib.version = VERSION;
