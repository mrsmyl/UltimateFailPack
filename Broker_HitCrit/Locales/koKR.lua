...
L["If you notice errors or values not updating, try clearing out values."] = "오류가 발생하거나 값이 갱신되지 않으면 모든 값을 초기화 하세요." -- Needs review
...
L["Please note: Due to changes in 4.2, you may need to clear data."] = "주의 : 4.2 패치로 인해 변경되었으니, 데이터를 초기화 하세요." -- Needs review
