--[[
	...
	Revision: $Id: BasicFilter.lua 5141 2011-05-04 02:58:37Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.11/Auc-Filter-Basic/BasicFilter.lua $", "$Rev: 5141 $")
