...
L["Invalid seller data returned by server."] = "Неверные данные продавца, возвращаемые сервером."
L["Item"] = "Товар"
...
L["Lowest auction by whitelisted player."] = "Самые низкии лоты у игрока из белого списка."
...
L["Match whitelist prices"] = "Совпадает с ценой из белого списка"
...
L["Max quantity to buy"] = "Макс качество для покупкт"
L["Max reset cost"] = "Максстоимость сброса"
...
L["Min reset profit"] = "Мин. сброс прибыли"
L["Modifiers:"] = "Модификаторы:"
L["Must wait for scan to finish before starting to reset."] = "Должно ждать завершения сканирования для начала сброса."
...
L["Not canceling auction below threshold."] = "Не отменять аукцион ниже порога"
...
L["Price gap too high."] = "Ценовой разрыв слишком высок"
...
L["Reset Auctions"] = "Сброс лотов"
L["Reset Method"] = "Метод сброса"
L["Reset Profile"] = "Сброс профиля"
L["Reset Scan Finished"] = "Сброс лотов завершен"
L["Reset Scan Settings"] = "Настройки сброса лотов"
...
L["Right click to do a custom cancel scan."] = "ПКМ, чтобы сделать выборочную отмену скана."
L["Right click to do a custom post scan."] = "ПКМ, чтобы сделать выборочный скан выставления"
L["Right click to do a custom reset scan."] = "GRV? чтобы сделать выборочный сбрасывающий скан "
