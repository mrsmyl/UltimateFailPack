...
L["Auction House"] = "Аукцион" -- Needs review
L["Auction House Value"] = "Рыночная стоимость" -- Needs review
L["Bags"] = "Сумки"
L["Bars"] = "Панели"
...
L["Checking this box will allow you to set a custom, fixed price for this item."] = "Назначить фиксированную стоимость для этого предмета" -- Needs review
L["Chest"] = "Грудь"
L["Class"] = "Класс"
...
-- L["<Crafting Stage #%s>"] = ""
L["Craft Item (x%s)"] = "Создать предмет (x%s)" -- Needs review
...
L["Custom"] = "Свои настройки" -- Needs review
L["Custom Value"] = "Своя цена" -- Needs review
...
L["Edit Custom Value"] = "Изменить свою цену" -- Needs review
L["Elixir"] = "Эликсир"
...
L["Mat Price"] = "Цена мат-ов" -- Needs review
...
L["Need"] = "Требуется"
L["New"] = "Новый"
L["<New Group>"] = "<Новая группа>" -- Needs review
L["<No Category>"] = "<Без категории>" -- Needs review
...
L["per pigment"] = "pза чернила" -- Needs review
-- L["Place lower limit on ilvl to craft"] = ""
L["Potion"] = "Зелье"
L["Price:"] = "Цена:" -- Needs review
-- L["Price / Inventory Settings"] = ""
-- L["Price Multiplier"] = ""
L["Price Settings"] = "Настройки стоимости"
L["Price Source"] = "Источник цены" -- Needs review
...
L["The item you want to base this mat's price on. You can either link the item into this box or type in the itemID from wowhead."] = "Предмет, на котором основана цена. Введите линк на предмет (shift+клик) или его ID." -- Needs review
