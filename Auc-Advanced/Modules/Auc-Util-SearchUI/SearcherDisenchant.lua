--[[
	...
	Revision: $Id: SearcherDisenchant.lua 5381 2012-11-27 19:42:13Z mentalpower $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.15/Auc-Util-SearchUI/SearcherDisenchant.lua $", "$Rev: 5381 $")
