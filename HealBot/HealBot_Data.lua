...
HealBot_Config_SkinsDefaults = {
  ...
  LowManaInd  = {[HEALBOT_SKINS_STD] = 3, [HEALBOT_OPTIONS_GROUPHEALS] = 4, [HEALBOT_OPTIONS_EMERGENCYHEALS] = 2, [HEALBOT_ZONE_AV] = 1,
                      [HEALBOT_SKIN_SQUARE] = 1, [HEALBOT_MAGIC] = 3, [HEALBOT_CLASSES_RANGES]=1, },
};
