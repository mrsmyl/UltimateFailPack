...
HealBot_GlobalsDefaults = {
    ...
    HealBot_Custom_Debuffs = {
		...
		[HEALBOT_DEBUFF_STORM_CLOUD]       = 10, -- Iron Qon
		[HEALBOT_DEBUFF_DEAD_ZONE]         = 10, -- Iron Qon
		...
		[HEALBOT_DEBUFF_UNSTABLE_VITA]     = 10, -- Ra-Den
		[HEALBOT_DEBUFF_VITA_SENSITIVITY]  = 10, -- Ra-Den
	    ...
	    --[HEALBOT_DEBUFF_TEST_OF_SERENITY]  = 10, -- Sha of Pride       
	    --[HEALBOT_DEBUFF_TEST_OF_RELIANCE]  = 10, -- Sha of Pride       
	    --[HEALBOT_DEBUFF_TEST_OF_CONDIDENCE] = 10, -- Sha of Pride        
		[HEALBOT_DEBUFF_MARK_OF_ARROGANCE] = 10, -- Sha of Pride Magic Effect	
	    ...
	    --[HEALBOT_DEBUFF_ANCIENT_MIASMA]    = 11, -- Malkorok       
