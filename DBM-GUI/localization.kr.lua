...
L.SKT_Enabled				= "각 우두머리 설정에서 끈 상태라도 가장 빨랐던 전투시간 바 보기(강제)"
...
L.WarningIconChat 			= "대화창에 아이콘 보기"
L.ShowCountdownText			= "초읽기 도중 글자 보기"
...
L.SpecialWarnSound			= "특수 경고 소리(당신이나 특정 대상에게만 사용되는 주문)"
L.SpecialWarnSound2			= "특수 경고 소리(모든 공격대원에게 사용되는 주문)"
L.SpecialWarnSound3			= "특수 경고 소리(전멸기, 매우 중요한 주문)"
...
L.Area_PullTimer				= "전투 예정/시작 설정"
L.DontShowPTNoID				= "현재 있는 지역에서 보내지 않은 전투 예정 신호 무시"
L.DontShowPT					= "전투 예정/시작 바 숨기기"
L.DontShowPTText				= "전투 예정/시작 대화 알림 숨기기"
L.DontPlayPTCountdown			= "전투 예정/시작 초읽기 소리 숨기기"
L.DontShowPTCountdownText		= "전투 예정/시작 초읽기 글자 숨기기"
L.PT_Threshold					= "전투 예정/시작 초읽기 글자를 몇 초부터 보여줄 것인지 설정: %d"
