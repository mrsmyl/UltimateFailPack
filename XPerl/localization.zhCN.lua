...
XPERL_LOC_ZONE_BARADIN_HOLD = "Baradin Hold"--No translation yet.
XPERL_LOC_ZONE_BLACKWING_DECENT = "黑翼血环"
XPERL_LOC_ZONE_BASTION_OF_TWILIGHT = "暮光堡垒"
XPERL_LOC_ZONE_THRONE_OF_FOUR_WINDS = "风神王座"
XPERL_LOC_ZONE_FIRELANDS			= "火焰之地"
XPERL_LOC_ZONE_DRAGONSOUL			= "巨龙之魂"
