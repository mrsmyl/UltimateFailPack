...
XPERL_LOC_ZONE_BARADIN_HOLD			= "巴拉丁堡"
XPERL_LOC_ZONE_BLACKWING_DECENT		= "黑翼陷窟"
XPERL_LOC_ZONE_BASTION_OF_TWILIGHT	= "暮光堡壘"
XPERL_LOC_ZONE_THRONE_OF_FOUR_WINDS	= "四風王座"
XPERL_LOC_ZONE_FIRELANDS			= "火源之界"
XPERL_LOC_ZONE_DRAGONSOUL			= "巨龍之魂"
