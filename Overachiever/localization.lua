...
L["OPT_TRADESKILL_SHOWCOMPLETEDACH_COOKING_TIP"] = "Если торговый модуль Overachiever'а включен, иконка достижения появится рядом с рецептом, который необходимо приготовить для получения соответствующего достижения. Если эта опция включена, то иконки появляться рядом с еще не приготовленными рецептами даже если эти достижения завершены." -- Needs review
...
L["ACH_FISHSCHOOL_FORMAT"] = "Escola: %s" -- Needs review
...
L["ACH_TURKEYLURKEY_COMPLETE"] = "Já depenado" -- Needs review
L["ACH_TURKEYLURKEY_INCOMPLETE"] = "Precisa de penas" -- Needs review
...
-- L["OPT_LABEL_NEEDTOKILL"] = ""
L["OPT_LABEL_SEASONALACHS"] = "CONQUISTAS SAZONAIS" -- Needs review
L["OPT_LABEL_TOOLTIPS"] = "Dicas para Conquistas"
L["OPT_LABEL_TRACKING"] = "Conquistas envidenciadas"
L["OPT_LABEL_TRADESKILLUI"] = "Modificações na Interface das Profissões" -- Needs review
L["OPT_LETITSNOWTIPS"] = "Punhado de Flocos de Neve utilizado?"
-- L["OPT_LETITSNOWTIPS_TIP"] = ""
L["OPTPANEL_REMINDERTOOLTIPS"] = "Tooltip de Lembrança" -- Needs review
-- L["OPT_PESTCONTROLTIPS"] = ""
-- L["OPT_PESTCONTROLTIPS_TIP"] = ""
L["OPT_SATISFIEDTIPS"] = "1000% Satisfeito?"
L["OPT_SATISFIEDTIPS_TIP"] = "Adiciona uma linha na tooltip dos itens que são partes do critério da conquista para indicar se você precisa consumí-lo." -- Needs review
...
L["OPT_TRADESKILL_SHOWCOMPLETEDACH_COOKING_TIP"] = "Se o módulo Overachiever Trade estiver habilitado, então um ícone da conquista aparece próximo às receitas que você precisa cozinhar para poder ganhar tal conquista. Se esta opção estiver checada, então esses ícones aparecerão próximos às receitas mesmo que a conquista associadas esteja completa." -- Needs review
L["OPT_TURKEYLURKEYTIPS"] = "Atirador de Peru usado?" -- Needs review
L["OPT_TURKEYLURKEYTIPS_TIP"] = "Se a conquista estiver incompleta, adiciona uma linha na tooltip dos jogadores para indicar se você precisa usar seu Atirador de Peru neles." -- Needs review
-- L["OPT_UI_REQUIREDFORMETATIP"] = ""
-- L["OPT_UI_REQUIREDFORMETATIP_TIP"] = ""
-- L["OPT_UI_SERIESTIP"] = ""
-- L["OPT_UI_SERIESTIP_TIP"] = ""
...
L["MSG_ACHNOTFOUND"] = "Obiettivo non Trovato."
L["MSG_INVALIDID"] = "Input non valido: non esiste un'impresa con quell'ID."
L["MSG_NAMENOTFOUND"] = "Nessun obiettivo con nome contenente \"|cffffffff%s|r\" è stato trovato."
L["MSG_NUMFOUNDLIST"] = "%s altri obiettivi trovati:"
L["MSG_ONEFOUND"] = "1 altro obiettivo trovato:"
...
L["OPT_ANGLERTIPS_TIP"] = "Se l'obiettivo è incompleto, aggiungi una linea ai tooltip dei nodi di pesca che fanno parte del suo criterio per indicare se hai bisogno o meno di pescarli."
L["OPT_AUTOTRACKEXPLORE"] = "Autotraccia gli obiettivi di esplorazione mentre viaggi"
L["OPT_AUTOTRACKEXPLORE_COMPLETED"] = "Includi obiettivi completati"
L["OPT_AUTOTRACKEXPLORE_TIP"] = "QUando entri in una zona, verrà tracciato automaticamente l'obbiettivo di esplorazione associato. Non cambierà se stai tracciando qualcos'altro diverso da un obiettivo di esplorazione."
...
L["OPT_LETITSNOWTIPS_TIP"] = "Se il risultato è incompleto, aggiungere una riga nel tooltip del giocatore con la combo razza/classe appropriata per indicare se è necessario utilizzare una manciata di fiocchi di neve su di loro."
