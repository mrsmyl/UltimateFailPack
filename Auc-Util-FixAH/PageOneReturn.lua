--[[
	...
	Revision: $Id: PageOneReturn.lua 5184 2011-06-24 00:16:48Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.12/Auc-Util-FixAH/PageOneReturn.lua $", "$Rev: 5184 $")
